import{_ as n,o as s,c as a,d as p}from"./app-8d691574.js";const t={},e=p(`<h1 id="vue2-项目简易封装-axios" tabindex="-1"><a class="header-anchor" href="#vue2-项目简易封装-axios" aria-hidden="true">#</a> Vue2 项目简易封装 Axios</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>日常开发前后端分离项目时，经常会使用到 axios 这个 HTTP 库。下面对它进行简易封装做了归纳整理。</p><h2 id="目录" tabindex="-1"><a class="header-anchor" href="#目录" aria-hidden="true">#</a> 目录</h2><p>目录结构，我一般是这么安排的</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>|- src
|-- api
|--- index.js
|--- sendMsg.js
|-- utils
