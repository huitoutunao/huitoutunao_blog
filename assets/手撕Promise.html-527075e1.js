import{_ as t,r as p,o as c,c as o,a as n,b as a,e,d as i}from"./app-01af8480.js";const l="/images/js_subject/promise4.png",u="/images/js_subject/promise1.png",r="/images/js_subject/promise2.png",d="/images/js_subject/promise3.png",k="/images/js_subject/promise5.png",v="/images/js_subject/promise6.png",m="/images/js_subject/promise7.png",b="/images/js_subject/promise8.png",h="/images/js_subject/promise9.png",g={},f=i(`<h1 id="手撕-promise" tabindex="-1"><a class="header-anchor" href="#手撕-promise" aria-hidden="true">#</a> 手撕 Promise</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>不论是前端日常开发，还是前端面试题，总是会遇到 Promise 相关的问题。因此今天就来一探究竟，揭开 Promise 的神秘面纱。</p><h2 id="基本结构" tabindex="-1"><a class="header-anchor" href="#基本结构" aria-hidden="true">#</a> 基本结构</h2><ul><li>构造函数里传入一个函数，它有两个形参 <code>resolve</code>、<code>reject</code></li><li><code>resolve</code> 函数成功时执行</li><li><code>reject</code> 函数失败时执行</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Promise</span> <span class="token punctuation">{</span>
