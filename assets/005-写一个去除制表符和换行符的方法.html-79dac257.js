import{_ as n,o as s,c as a,d as e}from"./app-66d59838.js";const t={},p=e(`<h1 id="_005-写一个去除制表符和换行符的方法" tabindex="-1"><a class="header-anchor" href="#_005-写一个去除制表符和换行符的方法" aria-hidden="true">#</a> 005-写一个去除制表符和换行符的方法</h1><p>知识点：</p><ul><li>正则匹配</li></ul><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * \\f  匹配换页字符。
 * \\n  匹配换行字符。
 * \\r  匹配回车符字符。
 * \\t  匹配制表字符。
