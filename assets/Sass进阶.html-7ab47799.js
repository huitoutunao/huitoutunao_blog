import{_ as p,r as t,o as c,c as o,a as n,b as a,e,d as i}from"./app-665c4bcb.js";const l="/images/essays/sass_1.png",u={},d=i(`<h1 id="sass-进阶" tabindex="-1"><a class="header-anchor" href="#sass-进阶" aria-hidden="true">#</a> Sass 进阶</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>日常开发主要使用 Sass 语法编写样式，所以这里记录 Sass 几个好用的技巧。</p><h2 id="控制指令" tabindex="-1"><a class="header-anchor" href="#控制指令" aria-hidden="true">#</a> 控制指令</h2><p>在编写 <code>@mixin</code> 和 <code>@function</code> 时提供逻辑判断。</p><h3 id="if" tabindex="-1"><a class="header-anchor" href="#if" aria-hidden="true">#</a> @if</h3><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token property"><span class="token variable">$boolean</span></span><span class="token punctuation">:</span> <span class="token boolean">true</span> <span class="token statement keyword">!default</span><span class="token punctuation">;</span>
