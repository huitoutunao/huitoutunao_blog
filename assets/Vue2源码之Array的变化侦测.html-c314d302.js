import{_ as a,r as p,o as e,c as t,a as n,b as o,e as c,d as i}from"./app-bc941942.js";const l={},u=i(`<h1 id="vue2-源码之-array-的变化侦测" tabindex="-1"><a class="header-anchor" href="#vue2-源码之-array-的变化侦测" aria-hidden="true">#</a> Vue2 源码之 Array 的变化侦测</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>这是 <code>Vue.js</code> 的源码分析，记录自己在学习源码时的心得和收获。</p><p><code>Vue.js</code> 的源码目录结构如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>src
├── compiler        # 编译相关
├── core            # 核心代码
├── platforms       # 不同平台的支持
├── server          # 服务端渲染
